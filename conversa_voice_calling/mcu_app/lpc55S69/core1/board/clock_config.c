...
outputs:
- {id: MCLK_clock.outFreq, value: 24.576 MHz, locked: true, accuracy: '0.001'}
...
- {id: SYSCON.MCLKDIV.scale, value: '5'}
- {id: SYSCON.PLL0CLKSEL.sel, value: ANACTRL.fro_12m_clk}
- {id: SYSCON.PLL0M_MULT.scale, value: '41'}
- {id: SYSCON.PLL1CLKSEL.sel, value: ANACTRL.fro_12m_clk}
- {id: SYSCON.PLL1M_MULT.scale, value: '25'}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    POWER_DisablePD(kPDRUNCFG_PD_PLL0_SSCG);
    const pll_setup_t pll0Setup = {
        .pllctrl = SYSCON_PLL0CTRL_CLKEN_MASK | SYSCON_PLL0CTRL_SELI(23U) | SYSCON_PLL0CTRL_SELP(11U),
        .pllndec = SYSCON_PLL0NDEC_NDIV(1U),
        .pllpdec = SYSCON_PLL0PDEC_PDIV(2U),
        .pllsscg = {0x0U,(SYSCON_PLL0SSCG1_MDIV_EXT(41U) | SYSCON_PLL0SSCG1_SEL_EXT_MASK)},
        .pllRate = 123000000U,
        .flags =  PLL_SETUPFLAG_WAITLOCK
    };
    CLOCK_SetPLL0Freq(&pll0Setup);                       /*!< Configure PLL0 to the desired values */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivMClk, 5U, false);         /*!< Set MCLKDIV divider to value 5 */
