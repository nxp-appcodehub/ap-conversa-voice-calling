...
#define AUDIO_SPEAKER_DATA_WHOLE_BUFFER_COUNT (32U)
#else
...
#if defined(USB_DEVICE_CONFIG_LPCIP3511HS) && (USB_DEVICE_CONFIG_LPCIP3511HS > 0U)
#define AUDIO_PLL_ADJUST_INTERVAL (8U)			//this is 1ms every adjust
...
//#define AUDIO_PLL_ADJUST_DATA_BASED_INTERVAL    (2U)
