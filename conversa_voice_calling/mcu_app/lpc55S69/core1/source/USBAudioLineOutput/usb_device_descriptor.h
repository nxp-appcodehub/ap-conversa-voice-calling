...
#define USB_DEVICE_MAX_POWER (0xFAU) // UPDATE to 500mA
...
#define USB_AUDIO_COMPOSITE_INTERFACE_COUNT                                                 \
    (USB_AUDIO_SPEAKER_CONTROL_INTERFACE_COUNT + USB_AUDIO_SPEAKER_STREAM_INTERFACE_COUNT + USB_AUDIO_RECORDER_STREAM_INTERFACE_COUNT)

#if (AUDIO_IN_SAMPLING_RATE_KHZ!=AUDIO_OUT_SAMPLING_RATE_KHZ)
#error in this program, for UAC 2.0, AUDIO_IN_SAMPLING_RATE_KHZ must == AUDIO_OUT_SAMPLING_RATE_KHZ
#endif
...
#define USB_CDC_VCOM_DIC_BULK_IN_ENDPOINT (4)
