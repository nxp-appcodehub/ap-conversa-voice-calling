...
enum
{
	...
	//the following are copied from Rt1170 SDK example
	kStatus_NullPointer = MAKE_STATUS(kStatusGroup_Generic, 8),   /*!< Generic status for null pointer argument. */
	kStatus_NotCompatible = MAKE_STATUS(kStatusGroup_Generic, 9),   /*!< Generic status for not compatible configuration */
	kStatus_cbFull = MAKE_STATUS(kStatusGroup_Generic, 10),   /*!< Generic status for circular buffer full */
	kStatus_cbEmpty = MAKE_STATUS(kStatusGroup_Generic, 11),   /*!< Generic status for circular buffer empty */
	kStatus_LicenseError = MAKE_STATUS(kStatusGroup_Generic, 12),   /*!< Generic status for License error */
};
