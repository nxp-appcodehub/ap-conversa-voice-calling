...
outputs:
- {id: MCLK_clock.outFreq, value: 187.2/7 MHz}
...
- {id: SYSCON.PLL0M_MULT.scale, value: '156', locked: true}
- {id: SYSCON.PLL0N_DIV.scale, value: '5', locked: true}
- {id: SYSCON.PLL0_PDEC.scale, value: '14', locked: true}
- {id: SYSCON.PLL1CLKSEL.sel, value: ANACTRL.fro_12m_clk}
- {id: SYSCON.PLL1M_MULT.scale, value: '25', locked: true}
...
void BOARD_BootClockPLL150M(void)
{
	...
	#endif
	#if 1
		//the following is from the SDK USB audio example
		#if 0
		//usb full speed
			/*!< Set up PLL */
			CLOCK_AttachClk(kFRO12M_to_PLL0);                    /*!< Switch PLL0CLKSEL to FRO12M */
			...
			const pll_setup_t pll0Setup = {
				.pllctrl = SYSCON_PLL0CTRL_LIMUPOFF_MASK | SYSCON_PLL0CTRL_CLKEN_MASK | SYSCON_PLL0CTRL_SELI(4U) | SYSCON_PLL0CTRL_SELP(3U),
				.pllndec = SYSCON_PLL0NDEC_NDIV(3U),
				.pllpdec = SYSCON_PLL0PDEC_PDIV(8U),
				.pllsscg = {(SYSCON_PLL0SSCG0_MD_LBS(3298534883U)), (SYSCON_PLL0SSCG1_MD_MBS(0U) | (uint32_t)(kSS_MF_512) | (uint32_t)(kSS_MR_K0) | (uint32_t)(kSS_MC_NOC))},
				.pllRate = 24576000U,
	...
	//this is auto generated --- won't be used
    const pll_setup_t pll0Setup = {
        .pllctrl = SYSCON_PLL0CTRL_CLKEN_MASK | SYSCON_PLL0CTRL_SELI(51U) | SYSCON_PLL0CTRL_SELP(31U),
        .pllndec = SYSCON_PLL0NDEC_NDIV(5U),
        .pllpdec = SYSCON_PLL0PDEC_PDIV(7U),
        .pllsscg = {0x0U,(SYSCON_PLL0SSCG1_MDIV_EXT(156U) | SYSCON_PLL0SSCG1_SEL_EXT_MASK)},
        .pllRate = 26742857U,
        .flags =  PLL_SETUPFLAG_WAITLOCK
    };
	#endif
    ...
    const pll_setup_t pll1Setup = {
        .pllctrl = SYSCON_PLL1CTRL_CLKEN_MASK | SYSCON_PLL1CTRL_SELI(15U) | SYSCON_PLL1CTRL_SELP(7U),
        .pllndec = SYSCON_PLL1NDEC_NDIV(1U),
        .pllpdec = SYSCON_PLL1PDEC_PDIV(1U),
        .pllmdec = SYSCON_PLL1MDEC_MDIV(25U),
        .pllRate = 150000000U,
        .flags =  PLL_SETUPFLAG_WAITLOCK
    };
