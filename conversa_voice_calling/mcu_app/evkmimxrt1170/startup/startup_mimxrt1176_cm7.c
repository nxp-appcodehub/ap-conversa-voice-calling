...
#include "fsl_device_registers.h"
 ...
 #include "board.h" // for gpio mips measure
...
// handler is included.
//*****************************************************************************
WEAK void DMA0_DMA16_IRQHandler(void) // EDMA connected to SAI
{
#ifdef MIPS_MEASURE_GPIO
	GPIO_PinWrite(BOARD_USER_MIPS_GPIO_3, BOARD_USER_MIPS_GPIO_3_PIN, 1); // BOARD_USER_MIPS_GPIO_3_PURPOSE_TEXT pin to 1
#endif

	DMA0_DMA16_DriverIRQHandler();

#ifdef MIPS_MEASURE_GPIO
	GPIO_PinWrite(BOARD_USER_MIPS_GPIO_3, BOARD_USER_MIPS_GPIO_3_PIN, 0); // BOARD_USER_MIPS_GPIO_3_PURPOSE_TEXT pin to 0
#endif
}
...
WEAK void DMA2_DMA18_IRQHandler(void) // EDMA connected to PDM
{
#ifdef MIPS_MEASURE_GPIO
	GPIO_PinWrite(BOARD_USER_MIPS_GPIO_2, BOARD_USER_MIPS_GPIO_2_PIN, 1); // BOARD_USER_MIPS_GPIO_2_PURPOSE_TEXT pin to 1
#endif

	DMA2_DMA18_DriverIRQHandler();

#ifdef MIPS_MEASURE_GPIO
	GPIO_PinWrite(BOARD_USER_MIPS_GPIO_2, BOARD_USER_MIPS_GPIO_2_PIN, 0); // BOARD_USER_MIPS_GPIO_2_PURPOSE_TEXT pin to 0
#endif
