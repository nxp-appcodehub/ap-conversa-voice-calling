...
#endif
#ifndef BOARD_USER_LED_GPIO_PIN_2
#define BOARD_USER_LED_GPIO_PIN_2 (25U)
#endif
...
#define BOARD_USER_BUTTON_NAME        "SW7 (USER_BUTTON)"


/*
 *   Define GPIO used for MIPS measure
 */
#ifdef MIPS_MEASURE_GPIO
	// Define GPIO base number
	#define BOARD_USER_MIPS_GPIO_1 	GPIO11
	#define BOARD_USER_MIPS_GPIO_2 	GPIO11
	#define BOARD_USER_MIPS_GPIO_3 	GPIO9
	#define BOARD_USER_MIPS_GPIO_4 	GPIO8
	#define BOARD_USER_MIPS_GPIO_5 	GPIO9
	#define BOARD_USER_MIPS_GPIO_6 	GPIO9
	// Define GPIO Pin
	#define BOARD_USER_MIPS_GPIO_1_PIN 	12
	#define BOARD_USER_MIPS_GPIO_2_PIN 	11
	#define BOARD_USER_MIPS_GPIO_3_PIN   4
	#define BOARD_USER_MIPS_GPIO_4_PIN 	31
	#define BOARD_USER_MIPS_GPIO_5_PIN 	13
	#define BOARD_USER_MIPS_GPIO_6_PIN 	12
	// Define GPIO text to print according platform selection
	#define BOARD_USER_MIPS_GPIO_1_PURPOSE_TEXT	"GPIO_DISP_B2_11 /  J9 Pin  2 / GPIO11_IO12: Time spent in USB audio composite ISR (USB audio Rx/Tx + Vcom port)"
	#define BOARD_USER_MIPS_GPIO_2_PURPOSE_TEXT	"GPIO_DISP_B2_10 /  J9 Pin  4 / GPIO11_IO11: Time spent in EDMA PDM ISR (microphone capture)"
	#define BOARD_USER_MIPS_GPIO_3_PURPOSE_TEXT	"GPIO_AD_05      /  J9 Pin 12 / GPIO9_IO04 : Time spent in EDMA SAI ISR (speaker play back)"
    #define BOARD_USER_MIPS_GPIO_4_PURPOSE_TEXT	"GPIO_AD_00      /  J9 Pin 14 / GPIO8_IO31 : Time spent in Shell Task"
	#define BOARD_USER_MIPS_GPIO_5_PURPOSE_TEXT	"GPIO_AD_14      /  J9 Pin 16 / GPIO9_IO13 : Time spent in Audio Task"
	#define BOARD_USER_MIPS_GPIO_6_PURPOSE_TEXT	"GPIO_AD_13      / J26 Pin  8 / GPIO9_IO12 : Time spent in Audio Task process part only"
#endif
