...
#include "board.h" // for gpio TODO SDK UPDATE
...
#ifdef MIPS_MEASURE_GPIO //TODO SDK UPDATE
        	GPIO_PinWrite(BOARD_USER_MIPS_GPIO_4, BOARD_USER_MIPS_GPIO_4_PIN, 0); // BOARD_USER_MIPS_GPIO_4_PURPOSE_TEXT pin to 1
#endif
...
#ifdef MIPS_MEASURE_GPIO  //TODO SDK UPDATE
        	GPIO_PinWrite(BOARD_USER_MIPS_GPIO_4, BOARD_USER_MIPS_GPIO_4_PIN, 1); // BOARD_USER_MIPS_GPIO_4_PURPOSE_TEXT pin to 0
#endif
				...
				} // end if (0U != (ev & SHELL_EVENT_DATA_ARRIVED))
#if (defined(SHELL_NON_BLOCKING_MODE) && (SHELL_NON_BLOCKING_MODE > 0U))
...
#if (defined(SHELL_USE_COMMON_TASK) && (SHELL_USE_COMMON_TASK > 0U))
#else
            } // end if (KOSA_StatusSuccess == OSA_EventWait ...)
